              ...
              <div>
                ...
                <div className='grid md:grid-cols-2 gap-4'>
                  {project.features.map((feature, index) => (
                    <div
                      key={index}
                      className={`flex items-center gap-3 p-4 glass-effect rounded-xl hover:bg-white/5 hover:scale-105 transition-all duration-500 animate-slide-up animation-delay-${
                        1200 + index * 100
              ...
              <div>
                ...
                <div className='space-y-4'>
                  {project.challenges.map((challenge, index) => (
                    <div
                      key={index}
                      className={`p-4 glass-effect rounded-xl border-l-4 border-orange-400/50 hover:border-orange-400/80 hover:bg-orange-400/5 hover:scale-[1.02] transition-all duration-500 animate-slide-up animation-delay-${
                        1400 + index * 150
                      } hover:animate-float`}
                    >
              ...
              <div>
                ...
                <div className='space-y-4'>
                  {project.potentialImprovements.map((improvement, index) => (
                    <div
                      key={index}
                      className={`p-4 glass-effect rounded-xl border-l-4 border-green-400/50 hover:border-green-400/80 hover:bg-green-400/5 hover:scale-[1.02] transition-all duration-500 animate-slide-up animation-delay-${
                        1600 + index * 150
                      } hover:animate-glow`}
                    >
            ...
            <div>
              ...
              <div className='flex flex-wrap gap-3'>
                {project.tech.map((tech, index) => (
                  <span
                    key={index}
                    className={`px-4 py-2 glass-effect rounded-full text-sm border border-white/10 hover:border-indigo-400/50 hover:scale-105 transition-all duration-300 animate-slide-up animation-delay-${
                      1200 + index * 50
                    }`}
                  >
                    {tech}
        ...
        <div className='text-center mt-16'>
          <div className='glass-effect rounded-3xl p-8 border border-white/10 hover:scale-[1.02] hover:bg-white/5 transition-all duration-500 animate-slide-up animation-delay-1900'>
            ...
            <p className='text-gray-300 mb-6 max-w-2xl mx-auto'>
              I&apos;m always excited to work on innovative projects. Let&apos;s
