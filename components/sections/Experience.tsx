...
const experienceData: ExperienceItem[] = [
  {
    ...
    description: [
      ...
      'Working with modern backend technologies and frameworks',
...
export default function Experience() {
  ...
  return (
    <section className='relative py-20 px-6 bg-linear-to-br from-gray-900 via-slate-900 to-black overflow-hidden'>
      {/* Background effects */}
            ...
            {experienceData.map((item, index) => (
              ...
              >
                ...
                <div className='ml-8 flex-1'>
                  <div
                    className={`bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 transition-all duration-500 ${
                      hoveredItem === index
