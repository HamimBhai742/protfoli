      ...
      <div className="max-w-6xl mx-auto p-3">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-gray-400 text-sm">
            © 2024 Hamim. All rights reserved.
          </div>
          ...
          <div className="flex space-x-4">
            {[
              ...
              <a
                ...
                className="w-8 h-8 glass-effect rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 hover:scale-110 border border-white/10 hover:border-white/30"
                title={social.name}
              >
                {social.icon}
              </a>
